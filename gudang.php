              ...
              <form class="form-horizontal" action="add.php" method="post">
               <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="no_gudang" placeholder="NO_GUDANG">
                </div>
                <div class="form-group col-md-6">
                  <label for="">ID TOKO</label>
                  <input type="text" class="form-control" name="id_toko" placeholder="ID_TOKO">
                </div>
                <div class="form-group col-md-6">
                  <label for="">NAMA GUDANG</label>
                  <input type="text" class="form-control" name="nama_gudang" placeholder="NAMA_GUDANG">
                </div>
                <div class="form-row">
                <div class="form-group col-md-6">
